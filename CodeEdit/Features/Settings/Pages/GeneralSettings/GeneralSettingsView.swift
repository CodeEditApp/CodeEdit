...
private extension GeneralSettingsView {
    ...
    private var showIssues: some View {
    ...
    private var showLiveIssues: some View {
        Toggle("Show Live Issues", isOn: $prefs.preferences.general.showLiveIssues)
    }

    private var fileExtensions: some View {
        Group {
    ...
    private var fileIconStyle: some View {
    ...
    private var tabBarStyle: some View {
    ...
    private var reopenBehavior: some View {
    ...
    private var afterWindowsCloseBehaviour: some View {
        Picker(
    ...
    private var projectNavigatorSize: some View {
    ...
    private var findNavigatorDetail: some View {
    ...
    private var issueNavigatorDetail: some View {
    ...
    private var dialogWarnings: some View {
    ...
    private var shellCommand: some View {
    ...
    private var updateChecker: some View {
        Section {
            LabeledContent {
                Button("Check Now") {
    ...
    private var prereleaseToggle: some View {
    ...
    private var openInCodeEditToggle: some View {
    ...
    private var revealFileOnFocusChangeToggle: some View {
    ...
    private func fallbackShellInstallation(commandPath: String, destinationPath: String) {
        let cmd = [
            "osascript",
            "-e",
