...
extension AppPreferences {
    ...
    struct TextEditingSettings: Codable {
        ...
        /// Adds toggle-able settings to the command palette via shared `CommandManager`
        private func populateCommands() {
            ...
            mgr.addCommand(
                ...
                command: CommandClosureWrapper {
                    SettingsModel.shared.settings.textEditing.enableTypeOverCompletion.toggle()
                }
            )
            ...
            mgr.addCommand(
                ...
                command: CommandClosureWrapper {
                    SettingsModel.shared.settings.textEditing.autocompleteBraces.toggle()
                }
            )
            ...
            mgr.addCommand(
                ...
                command: CommandClosureWrapper {
                    SettingsModel.shared.settings.textEditing.wrapLinesToEditorWidth.toggle()
                }
            )
        }
    }
