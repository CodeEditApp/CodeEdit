...
//struct GitClient {
//    var getCurrentBranchName: () throws -> String
//    var getBranches: (Bool) throws -> [String]
//    var checkoutBranch: (String) throws -> Void
//    var pull: () throws -> Void
//    var cloneRepository: (String) -> AnyPublisher<CloneProgressResult, GitClientError>
//    /// Displays paths that have differences between the index file and the current HEAD commit,
//    /// paths that have differences between the working tree and the index file, and paths in the working tree
//    var getChangedFiles: () throws -> [ChangedFile]
//    /// Get commit history
//    /// - Parameters:
...
//    var getCommitHistory: (_ entries: Int?, _ fileLocalPath: String?) throws -> [Commit]
//
//    init(
