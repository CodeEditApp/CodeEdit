...
extension CodeLanguage {
    static let knownLanguages = [
        ...
        CodeLanguage(id: HighlightrLanguage.elixir, displayName: "Elixir", extensions: ["elixir"]),
        CodeLanguage(id: HighlightrLanguage.elm, displayName: "Elm", extensions: ["elm"]),
        CodeLanguage(id: HighlightrLanguage.ruby, displayName: "Ruby", extensions: ["ruby"]),
        CodeLanguage(id: HighlightrLanguage.erb, displayName: "Erb", extensions: ["erb"]),
        CodeLanguage(id: HighlightrLanguage.erlang, displayName: "Erlang", extensions: ["erlang"]),
