...
Please note this project spans [multiple repositories](https://github.com/CodeEditApp/CodeEdit#related-repositories) so instead of browsing issues in the issues tab, it may be helpful to find an issue in our [project board](https://github.com/orgs/CodeEditApp/projects/3/views/1).
